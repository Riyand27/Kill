...
import time, random, sys, re, os, json, subprocess, threading, string, codecs, requests, ctypes, urllib, urllib2, wikipedia, goslate
mulai = time.time()

cl = LINETCR.LINE()
cl.login(token="EnQK3VQoZFWXOB02YKV0.FdoYGphnIjyhzhGO4pYTea.UVMLevzU2LWRPAe0zOOnqCLbJZpMoEieiyM8QqzlCIY=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EnPQBEBhVkFR2Bn9iCX3.DTYMwwr+f8FvTz75xR+DSW.QFAY/RmCJTldrqk+m1efibQ2FOcFjy2w5Pr9pKg7Zto=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="EnVqf7y8Ng0UZXkDB5af.QlFiG7KiwI2Qcb2N8WA03W.dfh8EBVZBk9H+ERe/VG4uMLNAJ6pTXjTyKLRF7CXJIY=")
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token="EnSRzkDbrYIfERssWrP4.BlNf1+80Qx/ErIJOKAZfba.7cuPGduXAR7fypZ2R3fPbV5cLZg2J5r0a8XQ8sge1xw=")
kc.loginResult()

ks = LINETCR.LINE()
ks.login(token="EnTLPhvOqCfL8TEmz3c2.Q9SB0pA0uZ8eRl+rZNwMuG.yyVEwrfstYgMhM99TLxIFWJh4+L8oAzbjbfLqJlyEyQ=")
ks.loginResult()

kt = LINETCR.LINE()
kt.login(token="EnK78nzjzpnu45Bpk2m2.Mf+PyvBVC271KGpSNCSxmG.U1nZZho9NpoBpq3BDW7Rc2aHF+4wr4mRCq28VSkTpAU=")
kt.loginResult()
...
crєαtєdвч : Riyand / line.me/ti/p/~gepengcharlez
"""
...
admin = ["u7c33b280f1cd889607647828e0fcad10"]
owner = ["u7c33b280f1cd889607647828e0fcad10"]
wait = {
    'contact':False,
    'autoJoin':True,
...
#==================================================================
              ...
              if msg.from_ in admin:
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': "u5eb2b6cf0c5536ec3c3978cd25feafa4"}
                cl.sendMessage(msg)
		cl.sendText(msg.to,"Itu bos gw 😎")
            elif msg.text in ["Rekan"]:
                msg.contentType = 13
                msg.contentMetadata = {'mid': "uadfd85841b5f18645653d4cfaf375bc0"}
                cl.sendMessage(msg)
		cl.sendText(msg.to,"Itu rekan gw 😎")
              ...
              if msg.from_ in admin:
                ...
                if msg.from_ in owner:
                    ...
                    cl.sendText(msg.to,"owner permission required.")
#==========================================================
            elif 'yan mid' in msg.text.lower():
               if msg.from_ in admin:
...
#=================================================================
              ...
              if msg.from_ in admin:
                if msg.to in wait['pname']:
                    cl.sendText(msg.to,"Namelock disabled.")
              ...
              if msg.from_ in admin:
				gid = msg.to
				autocancel[gid] = "poni"
				cl.sendText(msg.to,"Blockir invitation on")
            elif "Blockinvite:off" == msg.text:
              if msg.from_ in admin:
				try:
					del autocancel[msg.to]
					cl.sendText(msg.to,"Blockir invitation off")
				except:
					pass
 #================================================================           
#--------------------------------------------------------
...
#------------------------------------------------
            ...
            elif msg.text in ["yan","Ping","ping"]:
              if msg.from_ in admin:
                ki.sendText(msg.to,"iya bosku ada apa 🙋")
                kk.sendText(msg.to,"Iya bosku ada apa 🙋")
                kc.sendText(msg.to,"Iya bosku ada apa 🙋")
		ks.sendText(msg.to,"Iya bosku ada apa 🙋")
		kt.sendText(msg.to,"Iya bosku ada apa 🙋")
		cl.sendText(msg.to,"Good 👏")
...
#===============================================
            ...
            elif msg.text in ["Speed","Sp","sp","Responsetime"]:
	      if msg.from_ in admin:
                start = time.time()
                cl.sendText(msg.to, "Siaga bosku... 😎")
                elapsed_time = time.time() - start
                cl.sendText(msg.to, "%sseconds" % (elapsed_time))
		ki.sendText(msg.to, "%ss" % (elapsed_time))
		kk.sendText(msg.to, "%ss" % (elapsed_time))
		kc.sendText(msg.to, "%ss" % (elapsed_time))
		ks.sendText(msg.to, "%ss" % (elapsed_time))
		kt.sendText(msg.to, "%ss" % (elapsed_time))
#========================================
            elif msg.text in ["yan1 backup run"]:
                if msg.from_ in admin:
                    ...
                    print r
                    print i
            elif msg.text in ["yan2 backup run"]:
                if msg.from_ in admin:
                    ...
                    print r
                    print i
            elif msg.text in ["yan3 backup run"]:
                if msg.from_ in admin:
                    ...
                    print r
                    print i
            elif msg.text in ["yan4 backup run"]:
                if msg.from_ in admin:
                    ...
                    print r
                    print i
            elif msg.text in ["yan5 backup run"]:
                if msg.from_ in admin:
                    ...
                    print r
                    print i
            elif msg.text in ["yan6 backup run"]:
                if msg.from_ in admin:
...
#=================================================
              ...
              if msg.from_ in admin:
                    cl.sendText(msg.to, "Already lurking.")
                    try:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                f=codecs.open('st2__b.json','w','utf-8')
                                json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                                cl.sendText(msg.to,"Banned sukses")
                            except:
                                cl.sendText(msg.to,"Error")
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                f=codecs.open('st2__b.json','w','utf-8')
                                json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                                cl.sendText(msg.to,"Unban sukses")
                            except:
              ...
              if msg.from_ in admin:
                ...
                for target in targets:
                   try:
                      ...
                      f=codecs.open('st2__b.json','w','utf-8')
                      json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                      cl.sendText(msg.to,"Succes to a banned ")
                   except:
                      pass        
#============================================
            ...
            elif msg.text.lower() in ["mention all","kabeh","Kabeh"]:
              if msg.from_ in admin:
                group = cl.getGroup(msg.to)
